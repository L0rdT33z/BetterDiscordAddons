 ...
 * @author L0rdT33z
 * @source https://github.com/L0rdT33z/BetterDiscordAddons/tree/main/Plugins/LeaveVoiceWhenJoin
 * @updateUrl https://raw.githubusercontent.com/L0rdT33z/BetterDiscordAddons/main/Plugins/LeaveVoiceWhenJoin/LeaveVoiceWhenJoin.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {
	"info": {
		...
		"authors": [{
			"name": "L0rdT33z",
			"discord_id": "501714001823137823",
			"github_username": "L0rdT33z"
		}],
		"github": "https://github.com/L0rdT33z/BetterDiscordAddons/tree/main/Plugins/LeaveVoiceWhenJoin",
		"github_raw": "https://raw.githubusercontent.com/L0rdT33z/BetterDiscordAddons/main/Plugins/LeaveVoiceWhenJoin/LeaveVoiceWhenJoin.plugin.js"
	},
	"changelog": [{
		"type": "fixed",
		"title": "Fixes",
	...
	(() => {
		...
		var __webpack_modules__ = {
			36: (module, __webpack_exports__, __webpack_require__) => {
				...
				___CSS_LOADER_EXPORT___.push([module.id, ".LeaveVoiceWhenJoin-button-icon{cursor:pointer;align-items:center;display:flex;margin:0 8px;color:var(--interactive-normal)}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					icon: "LeaveVoiceWhenJoin-button-icon"
				};
			...
			713: (module, __webpack_exports__, __webpack_require__) => {
				...
				___CSS_LOADER_EXPORT___.push([module.id, "#LeaveVoiceWhenJoin{position:absolute;z-index:999}#LeaveVoiceWhenJoin .LeaveVoiceWhenJoin-notification-container{z-index:999}.LeaveVoiceWhenJoin-notification-container{min-width:220px;margin-top:20px;position:relative;align-items:center;overflow:hidden;display:flex;pointer-events:all;padding:15px;border-radius:4px}.LeaveVoiceWhenJoin-notification-topLeft{left:20px}.LeaveVoiceWhenJoin-notification-topRight{right:20px}.LeaveVoiceWhenJoin-notification-bottomLeft{bottom:20px;left:20px}.LeaveVoiceWhenJoin-notification-bottomRight{bottom:20px;right:20px}.LeaveVoiceWhenJoin-notification-closeButton{color:#ddd;position:absolute;right:3px;top:3px;opacity:.7}.LeaveVoiceWhenJoin-notification-progress{bottom:0;height:3px;position:absolute;width:100%;left:0}.LeaveVoiceWhenJoin-notification-progressBar{height:3px;background:#0870f3}.LeaveVoiceWhenJoin-notification-content{color:#ddd;display:flex}.LeaveVoiceWhenJoin-notification-closeButton:hover{opacity:1}.LeaveVoiceWhenJoin-notification-wrapper{display:flex;flex-direction:column;margin-left:10px}.LeaveVoiceWhenJoin-notification-wrapper .LeaveVoiceWhenJoin-notification-header{display:flex;flex-direction:row}.LeaveVoiceWhenJoin-notification-wrapper .LeaveVoiceWhenJoin-notification-header .LeaveVoiceWhenJoin-notification-username{color:#fff;font-weight:700}.LeaveVoiceWhenJoin-notification-wrapper .LeaveVoiceWhenJoin-notification-header .LeaveVoiceWhenJoin-notification-timestamp{font-size:.75rem;padding-top:3px;color:var(--channels-default)}.LeaveVoiceWhenJoin-notification-wrapper .LeaveVoiceWhenJoin-notification-message{line-height:10px}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					container: "LeaveVoiceWhenJoin-notification-container",
					topLeft: "LeaveVoiceWhenJoin-notification-topLeft",
					topRight: "LeaveVoiceWhenJoin-notification-topRight",
					bottomLeft: "LeaveVoiceWhenJoin-notification-bottomLeft",
					bottomRight: "LeaveVoiceWhenJoin-notification-bottomRight",
					closeButton: "LeaveVoiceWhenJoin-notification-closeButton",
					progress: "LeaveVoiceWhenJoin-notification-progress",
					progressBar: "LeaveVoiceWhenJoin-notification-progressBar",
					content: "LeaveVoiceWhenJoin-notification-content",
					wrapper: "LeaveVoiceWhenJoin-notification-wrapper",
					header: "LeaveVoiceWhenJoin-notification-header",
					username: "LeaveVoiceWhenJoin-notification-username",
					timestamp: "LeaveVoiceWhenJoin-notification-timestamp",
					message: "LeaveVoiceWhenJoin-notification-message"
				};
				StyleLoader.append(module.id, ___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___, ___CSS_LOADER_EXPORT___.locals);
			},
			865: (module, __webpack_exports__, __webpack_require__) => {
				...
				___CSS_LOADER_EXPORT___.push([module.id, ".LeaveVoiceWhenJoin-panel-clearButton{min-width:100px;width:100px;margin:10px;position:absolute;right:15px;z-index:99999}.LeaveVoiceWhenJoin-panel-contents{height:500px;overflow-y:scroll;overflow-x:hidden}.LeaveVoiceWhenJoin-panel-message{margin-top:1.0625rem}.LeaveVoiceWhenJoin-panel-empty{color:#ddd;margin:20px;text-align:center}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					clearButton: "LeaveVoiceWhenJoin-panel-clearButton",
					contents: "LeaveVoiceWhenJoin-panel-contents",
					message: "LeaveVoiceWhenJoin-panel-message",
					empty: "LeaveVoiceWhenJoin-panel-empty"
				};
				StyleLoader.append(module.id, ___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___, ___CSS_LOADER_EXPORT___.locals);
			},
			911: (module, __webpack_exports__, __webpack_require__) => {
				...
				___CSS_LOADER_EXPORT___.push([module.id, ".LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact{position:inherit}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact .LeaveVoiceWhenJoin-category-header{display:flex;align-items:center;justify-content:space-between;padding:2px;padding-left:10px;text-transform:uppercase;font-weight:600;font-size:.9rem}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-caret{float:right;display:inline-flex;color:var(--interactive-normal)}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-stroke{background-color:var(--background-modifier-accent);height:2px;flex:1;margin:0 5px 0 10px}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-label{color:var(--interactive-normal)}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-compact .LeaveVoiceWhenJoin-category-content{padding-left:20px;width:calc(100% - 40px)}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default{background:rgba(32,34,37,.3);border:1px solid #202225;margin:5px;cursor:pointer;border-radius:3px;--color: var(--interactive-normal)}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default:hover{--color: var(--interactive-hover)}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default .LeaveVoiceWhenJoin-category-header{padding-right:5px;padding:10px 15px;padding-bottom:0;display:flex;align-items:center;justify-content:space-between}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-stroke{display:none}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-divider{position:relative}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-label{font-size:1rem;font-weight:600;color:#fff;text-transform:uppercase}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default .LeaveVoiceWhenJoin-category-header .LeaveVoiceWhenJoin-category-caret{color:var(--color);transition:color .3s}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default.LeaveVoiceWhenJoin-category-opened .LeaveVoiceWhenJoin-category-content{padding:8px}.LeaveVoiceWhenJoin-category-category.LeaveVoiceWhenJoin-category-default.LeaveVoiceWhenJoin-category-opened .LeaveVoiceWhenJoin-category-header{background:rgba(32,34,37,.6)}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					category: "LeaveVoiceWhenJoin-category-category",
					compact: "LeaveVoiceWhenJoin-category-compact",
					header: "LeaveVoiceWhenJoin-category-header",
					caret: "LeaveVoiceWhenJoin-category-caret",
					stroke: "LeaveVoiceWhenJoin-category-stroke",
					label: "LeaveVoiceWhenJoin-category-label",
					content: "LeaveVoiceWhenJoin-category-content",
					default: "LeaveVoiceWhenJoin-category-default",
					divider: "LeaveVoiceWhenJoin-category-divider",
					opened: "LeaveVoiceWhenJoin-category-opened"
				};
				StyleLoader.append(module.id, ___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___, ___CSS_LOADER_EXPORT___.locals);
			},
			818: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				const package_namespaceObject = JSON.parse('{"um":{"u2":"LeaveVoiceWhenJoin"}}');
				...
				const DOMNode = Object.assign(document.createElement("div"), {
					id: "LeaveVoiceWhenJoin",
					className: "LeaveVoiceWhenJoin-notification-" + settings.get("inappPosition", "topleft")
				});
				function initialize() {
				...
				function shutdown() {
					const node = document.getElementById("LeaveVoiceWhenJoin");
				...
				settings.addChangeListener((() => {
					...
					DOMNode.className = "LeaveVoiceWhenJoin-notification-" + value;
				}));
				...
				const clyde = Clyde;
				var LeaveVoiceWhenJoin_React = __webpack_require__(113);
				function LeaveVoiceWhenJoin_defineProperty(obj, key, value) {
					if (key in obj) Object.defineProperty(obj, key, {
						value,
						enumerable: true,
						configurable: true,
				...
				class LeaveVoiceWhenJoin extends(external_BasePlugin_default()) {
					constructor(...args) {
						super(...args);
						LeaveVoiceWhenJoin_defineProperty(this, "logs", []);
						LeaveVoiceWhenJoin_defineProperty(this, "lastStates", {});
						LeaveVoiceWhenJoin_defineProperty(this, "logsRef", LeaveVoiceWhenJoin_React.createRef());
						LeaveVoiceWhenJoin_defineProperty(this, "currentVoiceChannelId", void 0);
						LeaveVoiceWhenJoin_defineProperty(this, "openLogs", (() => {
							(0, modal_namespaceObject.openModal)((props => LeaveVoiceWhenJoin_React.createElement(modal_namespaceObject.ModalRoot, props, LeaveVoiceWhenJoin_React.createElement(LogsPanel, null))));
						}));
						LeaveVoiceWhenJoin_defineProperty(this, "onVoiceStateChange", (props => {
							for (const update of props.voiceStates) {
								...
								if (!this.lastStates[update.userId]) {
									if (settings.get("join", true)) {
										pushToLog(update.userId + "Joined the call.");
										if(blacklist.includes(update.userId)){
												this.selectVoiceChannel = BdApi.findModuleByProps("selectChannel").selectVoiceChannel;
												this.selectVoiceChannel(0);
										}
						...
						LeaveVoiceWhenJoin_defineProperty(this, "onSelect", (e => {
							this.logs = [];
							this.lastStates = {};
					...
					getSettingsPanel() {
						return LeaveVoiceWhenJoin_React.createElement(SettingsPanel, null);
					}
					onStart() {
					...
					async patchHeaderBar() {
						...
						external_PluginApi_namespaceObject.Patcher.after(HeaderBarContainer.component.prototype, "render", (_this => {
							...
							try {
								tree.unshift(LeaveVoiceWhenJoin_React.createElement(VoiceNotificationsButton, {
					...
					updateLogs({
						...
						if (useInApp) show(LeaveVoiceWhenJoin_React.createElement(LeaveVoiceWhenJoin_React.Fragment, null, LeaveVoiceWhenJoin_React.createElement(AnimatedAvatar, {
							isMobile: false,
							status: stores_namespaceObject.Status.getStatus(user.id),
							isTyping: false,
							src: user.getAvatarURL(),
							size: AvatarSizes.SIZE_32
						}), LeaveVoiceWhenJoin_React.createElement("div", {
							className: notification.Z.wrapper
						}, LeaveVoiceWhenJoin_React.createElement("div", {
							className: notification.Z.header
						}, LeaveVoiceWhenJoin_React.createElement("div", {
							className: notification.Z.username
						}, user.username), LeaveVoiceWhenJoin_React.createElement(MessageTimestamp, {
